...
Android app collusion is not a new concept \cite{Schlegel2011}, and multiple attempts have been made to develope a suitable detection system. \TODO{brief overview of existing approaches}
% Filtering
% 	rule-based
% 	machine learning
% model based
